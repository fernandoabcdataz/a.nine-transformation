...
WHERE Invoice.Contact.ContactPersons IS NOT NULL
...
WHERE Invoice.Contact.Phones IS NOT NULL
...
WHERE Invoice.Contact.Addresses IS NOT NULL
...
WHERE Invoice.Contact.ContactGroups IS NOT NULL
...
WHERE Invoice.InvoicePaymentServices IS NOT NULL
...
WHERE Invoice.Payments IS NOT NULL
...
WHERE Invoice.InvoiceAddresses IS NOT NULL
...
WHERE Invoice.LineItems IS NOT NULL
...
WHERE Invoice.Prepayments IS NOT NULL
...
WHERE Invoice.Overpayments IS NOT NULL
...
WHERE Invoice.CreditNotes IS NOT NULL